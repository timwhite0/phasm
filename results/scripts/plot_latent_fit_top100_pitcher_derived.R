...
for (metric in metrics) {
  ...
  write_csv(plot_df, file.path(results_dir, paste0("pitcher_latent_fit_derived_", metric, "_data.csv")))
  ...
  ggsave(filename = file.path(results_dir, paste0("pitcher_latent_fit_derived_", metric, ".pdf")),

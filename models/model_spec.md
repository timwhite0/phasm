## Hierarchical Bayesian Batter Projection Model (2026)
...
Note: This is a zero-mean AR(1). If you want a nonzero long-run mean $\mu_{\gamma,k}$,
replace the transitions with
$$
\gamma_{k,y} \sim \mathcal{N}((1-\rho_k)\mu_{\gamma,k} + \rho_k\gamma_{k,y-1}, \sigma_{\text{year},k})
$$
and add priors for $\mu_{\gamma,k}$.
